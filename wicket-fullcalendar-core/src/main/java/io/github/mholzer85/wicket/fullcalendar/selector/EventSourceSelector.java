...
package io.github.mholzer85.wicket.fullcalendar.selector;
...
public class EventSourceSelector extends WebComponent {

	private final FullCalendar calendar;


	public EventSourceSelector(@NonNull String id, @NonNull FullCalendar calendar) {
		super(id);
